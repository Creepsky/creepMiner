...
void Burst::Miner::run()
{
	...
	progressRead_->progressChanged.add(Poco::delegate(this, &Miner::progressReadChanged));
	progressVerify_->progressChanged.add(Poco::delegate(this, &Miner::progressVerifyChanged));
